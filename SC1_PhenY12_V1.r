...
# setwd( "/usr/home/qgg/haes/plant/r_base1")
n_all_var<-20
...
Variant_Global<-function(n_all_var,nvar){
		...
		cat('Selected initial var:',index,fill=TRUE)
...
which_sets<-which_sets2
which_step<-which_step2
which_sets
which_step
...
# cat('---------------------------',fill=TRUE)
# cat('Cycle number:',Cyl,'is Finished',fill=TRUE)
# cat('---------------------------',fill=TRUE)
...
# # # Acc of GS/phen selection for trait 1,3 amd 4 in F2_SP
	 # Acc_1<-rbind(ACC_tr134_F2_SP,ACC_tr134_F2_SP_Selected)
