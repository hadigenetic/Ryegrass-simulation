...
# This code uses Syn2 GROUP after year 12 as starting material
...
Year_changer<-function(Cyl,plan_XL,Sets){
...
Syn1_out<-Global_Syn1(F2,F2_SP,No_F2_Family_selected,nClonalrow,size_polycross,
...
cat('Steps in Year:',Cyl,'Finished',fill=TRUE)

texas<-list(F1_out,F2_Yellow,F2_W,F2_Green,F2_SP_out,S_Cross,
Syn1_out,Syn2_out,Syn2_W,Syn2_Green,mult,Syn3_out)
...
Combi_F2SP_Syn2<-Code_Varit1_Syn2
Combi_F2SP_Syn2
